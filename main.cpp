...
else
{
       ...
       BookDetails(nameOfBook, quantity, bookPrice);
        Author author(nameOfAuthor, authorGender,authorEmail);
       // Novel novel();
    //Book *book= &novel;
 ...
 if(bookType=='N')
   {
        ...
        Novel newNovel(novelGenre, ageGroup, novelRating, isHardCover, nameOfBook, quantity, author, bookPrice);
        Book *book = &newNovel;
      ...
      else
      {
        ...
        TextBook textbook( bookSubject,bookLevel,nameOfBook, bookPrice,author,quantity);
        Book *book= &textbook;

        cout<< book->toString();
        cout<<endl;
        cout<<"The total price for Text Book are:";
        cout << textbook.getValue();
        cout<<endl;
      }
